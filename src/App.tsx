...
function App({ conductor }: AppProps) {
  ...
  // Hilfsfunktion: PrÃ¼ft ob ein TMDB-Film bereits in der Bibliothek ist
        ...
        {state.filter === 'diary' ? (
          ...
          />
            ...
            <>
                ...
                {/* Tag filter: kollapsibel fÃ¼r mobile Usability */}
                {allTags.length > 0 && (
                    <div className="mb-4">
                        <button
                        ...
                        >
                            ...
                            <div className="absolute inset-0 z-10 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                ...
                                {movie.source === 'tmdb' && !isMovieInLibrary(movie) ? (
                                    <button
                                        ...
                                        title={t('common.addToWatchlist', 'Zur Watchlist hinzufÃ¼gen')}
                                    >
                                    ...
                                    <button
                                        ...
                                        className="bg-black/60 backdrop-blur-md p-2.5 rounded-full transition-all hover:scale-110 shadow-lg hover:bg-blue-500/40"
                                        title={t('common.inLibrary', 'In Bibliothek â€“ zum Detailansicht')}
                                    >
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-3 z-20">
                                ...
                                {movie.source !== 'tmdb' && typeof movie.userRating === 'number' && movie.userRating > 0 && (
                                    <div className="mt-1">
                                        <span className="text-xs text-yellow-400 font-bold drop-shadow-lg">â˜… {movie.userRating}/10</span>
                                    </div>
                                )}
                            </div>
                        </GlassCard>
